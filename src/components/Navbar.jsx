    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-center gap-4">
          <a href="https://www.spotify.com/in-en/premium/" target="_blank" className="bg-white text-black text-[15px] px-4 py-1 rounded-2xl hidden md:block cursor-pointer">
            Explore Premium
          </a>
          <a href="https://open.spotify.com/download" target="_blank"className="bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer">
            Install App
          </a>
